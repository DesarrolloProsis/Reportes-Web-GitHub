...
(function(trv, $, window, document, undefined) {
    ...
    function SendEmail(placeholder, options, otherOptions) {
        ...
        controller.getSendEmailDialogState(function(event, args) {
            ...
            toggle(args.visible);
        }).sendEmailReady(function(event, args) {
            closeWindow();
        ...
        function ensureInitialized() {
            if (!initialized) {
                ...
                kendoSendEmailDialog = $(".trv-send-email-window").kendoWindow({
                    ...
                    minHeight: 350,
                    maxHeight: 900,
                    appendTo: otherOptions.selector || "body",
                    close: function() {
                        storeDialogPosition();
                        clearValidation();
                    },
            ...
            if (!exportStartArgs.handled) {
                ...
                exportAsync(format, exportStartArgs.deviceInfo).then(function(info) {
                    ...
                    if (!exportEndArgs.handled) {
                        window.open(url, exportEndArgs.target);
                    }
                });
            }
        }
...
(function(trv, $, window, document, undefined) {
    ...
    trv.Events = {
        ...
        SEND_EMAIL_READY: "SEND_EMAIL_READY"
    };
    ...
    function ReportViewer(dom, options) {
        ...
        function attachEvents() {
            var viewerEventsMapping = {
                ...
                SEND_EMAIL_STARTED: controller.Events.SEND_EMAIL_STARTED,
                SEND_EMAIL_READY: controller.Events.SEND_EMAIL_READY
            }, $viewer = $(viewer);
        ...
        function attachEventHandlers() {
            ...
            eventBinder(trv.Events.SEND_EMAIL_STARTED, options.sendEmail, true);
            eventBinder(trv.Events.SEND_EMAIL_READY, options.sendEmail, true);
            $(controller).on(controller.Events.TOGGLE_SIDE_MENU, function() {
                window.setTimeout(function() {
...
/* DO NOT MODIFY OR DELETE THIS LINE! UPGRADE WIZARD CHECKSUM 2030A7FE2C9AE028AB0EB68B494746FC */